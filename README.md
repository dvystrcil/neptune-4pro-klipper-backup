...
| `chamber-ebb42.cfg` | BTT EBB42 (STM32G0B1) chamber controller — circulation fan (PA0) + SSR-triggered chamber heater (PA1) using existing chamber thermistor via `temperature_combined`, plus `M141`/`M191` overrides |
